...
public class UserRegistrationController {
    ...
    public ResponseEntity<ApiResponse<String>> resendOtpController(@RequestBody @Valid ResendOtpDto dto){
        String response= userRegistrationService.resendOtpService(dto);
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK,response));
    }
}
